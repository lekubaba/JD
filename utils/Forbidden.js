var Forbidden = {
    ...
    forbiddenArr : [
        ...
        "工字牌QB19","秃鹰汽长狗","仿真长狗","短狗","特级运动长弹","花山N306","柯尔特1911","狗配件",
        ...
        "pcp屠龙手","雄鹰M008","秃鹰全套","巴雷特","雷鸣顿","铅弹狗","射钉狗","德国colt","毛瑟c96","CP99",
        "工字牌lqb31","工字牌qb34","工字b33","猎狗粮","狙击之王M300","德瓦管","手拉98K",
        ...
        "12号猎枪","锡锋牌B8","pcp新贵","12号弹壳","ed50套件","双鹰M50","工字汽枪","温彻斯特1000x",
        ...
        "管改秃","真狗网","打鸟气枪网","快排吹图纸","硝基脲","榴弹","土制炸弹","土制手榴弹","土制手雷","起爆药",
        "塑胶炸药","自制炸药","C4橡胶炸药","土制火药","土制燃烧弹","火焰喷射器","引爆装置","空气炮","苦味酸","火药",
        "闪光弹","黑火药","硝铵炸药","迫击炮弹","炸弹","雷管","燃烧瓶","塑料炸弹","内裤炸弹","乳化炸药",
        "太恩","烟雾弹","黑索今","催泪弹","导弹","汽油弹","巡航导弹","氢弹","自制炸弹","爆破剂","液体炸药","高爆炸药",
        "军用雷管","工业雷管","电子炸弹","导火索","定时炸弹","鱼雷","遥控炸弹","土炸药","TNT炸药","炸药",
        ...
        "中年美妇","抓胸","自拍","自慰","作爱","18禁","a片","我日","gay片","g点","g片","h动画","h动漫",
        "sm女王","xing伴侣","yin荡","日你","日死你","日你全家","内幕","黑幕","机器人","我是机器人","测试人员"]
